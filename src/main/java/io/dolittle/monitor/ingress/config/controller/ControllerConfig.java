...
package io.dolittle.monitor.ingress.config.controller;
...
@Profile("controller")
@Configuration
@ComponentScan(basePackages = {"io.dolittle.monitor.ingress.controller"})
@ConfigurationPropertiesScan(basePackages = {"io.dolittle.monitor.ingress.controller.properties"})
@Slf4j
